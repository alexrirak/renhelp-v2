...
[![Building exterior preview](images/image-42-01_GEB.jpg?classes=img-maxsize)](images/image-42-01_GEB.jpg)
...
[![Exterior meshes](images/image-42-02_EXTMESH.jpg?classes=img-maxsize)](images/image-42-02_EXTMESH.jpg)

Then go to the **W3D-Tools → Assign Node Names** menu:

[![Assign node names](images/image-42-03_ASINGNAMES.jpg?classes=img-maxsize)](images/image-42-03_ASINGNAMES.jpg)
...
[![Root name dialog](images/image-42-04_ROOTNAMES.jpg?classes=img-maxsize)](images/image-42-04_ROOTNAMES.jpg)
...
[![Group exterior](images/image-42-05_GROUP.jpg?classes=img-maxsize)](images/image-42-05_GROUP.jpg)
...
[![Interior meshes](images/image-42-06_INT.jpg?classes=img-maxsize)](images/image-42-06_INT.jpg)

Select all those interior meshes and open the same naming dialog. Enter the Meshprefix followed by a `#`.

[![Interior naming](images/image-42-07_INT_2.jpg?classes=img-maxsize)](images/image-42-07_INT_2.jpg)

Then group them (for example, call the group `wep_int`).  

[![Group interior](images/image-42-08_GROUP_INT.jpg?classes=img-maxsize)](images/image-42-08_GROUP_INT.jpg)
...
[![Doors box](images/image-42-09_DOORS.jpg?classes=img-maxsize)](images/image-42-09_DOORS.jpg)
...
[![Link tool](images/image-42-11_LINK.jpg?classes=img-maxsize)](images/image-42-11_LINK.jpg)
[![Drag link](images/image-42-12_DRAG.jpg?classes=img-maxsize)](images/image-42-12_DRAG.jpg)
...
[![Trackview](images/image-42-13_TRACKVIEW.jpg?classes=img-maxsize)](images/image-42-13_TRACKVIEW.jpg)

In the Trackview, browse to **Objects → emitter75**:  

[![Emitter75 object](images/image-42-14_TW2.jpg?classes=img-maxsize)](images/image-42-14_TW2.jpg)

Add a *visibility track* (click the eye icon):  

[![Eye icon](images/image-42-15_EYE.jpg?classes=img-maxsize)](images/image-42-15_EYE.jpg)
You should then see a new option.  

[![Visibility track](images/image-42-16_VISIBLTRACK.jpg?classes=img-maxsize)](images/image-42-16_VISIBLTRACK.jpg)

Add keys at frames 1, 2, and 3 using the *Add Keys* button:  

[![Add keys](images/image-42-17_ADDKEYS.jpg?classes=img-maxsize)](images/image-42-17_ADDKEYS.jpg)
[![Added keys](images/image-42-18_ADDKEYS.jpg?classes=img-maxsize)](images/image-42-18_ADDKEYS.jpg)

Set the first key’s value to 0 (invisible), the second also to 0, and the third to 1 (visible):  

[![Set visibility](images/image-42-19_KEYOPTION.jpg?classes=img-maxsize)](images/image-42-19_KEYOPTION.jpg)
...
[![W3D files](images/image-42-20_W3DS.jpg?classes=img-maxsize)](images/image-42-20_W3DS.jpg)

Place them in your mod folder (e.g. `buildingparts`).  

[![Mod folder](images/image-42-21_FOLD.jpg?classes=img-maxsize)](images/image-42-21_FOLD.jpg)
...
[![W3D aggregate](images/image-42-23_W3D.jpg?classes=img-maxsize)](images/image-42-23_W3D.jpg)
...
[![Leveleditor add group](images/image-42-24_LEADGROUPT.jpg?classes=img-maxsize)](images/image-42-24_LEADGROUPT.jpg)
...
[![W3D select](images/image-42-25_W3DSEL.jpg?classes=img-maxsize)](images/image-42-25_W3DSEL.jpg)

Repeat for `meshprefix_int`:  

[![Add interior](images/image-42-26_GROUP.jpg?classes=img-maxsize)](images/image-42-26_GROUP.jpg)

In **Tiles** tab → Add → name: `mybuildingtiles`, set Physics Type to `BuildingAggregate`:  

[![Building tiles](images/image-42-27_BLDAGTILES.jpg?classes=img-maxsize)](images/image-42-27_BLDAGTILES.jpg)
...
[![Setup dam](images/image-42-28_SETUP_DAM.jpg?classes=img-maxsize)](images/image-42-28_SETUP_DAM.jpg)
...
[![Behavior setup](images/image-42-29_SETUP2.jpg?classes=img-maxsize)](images/image-42-29_SETUP2.jpg)
...
[![MCT tile](images/image-42-30_MCT.jpg?classes=img-maxsize)](images/image-42-30_MCT.jpg)
...
[![Final tiles](images/image-42-31_FINALY.jpg?classes=img-maxsize)](images/image-42-31_FINALY.jpg)
...
[![Clone controller](images/image-42-32_CLONE.jpg?classes=img-maxsize)](images/image-42-32_CLONE.jpg)

You can name it whatever you want.... but you must fill in the `MESHPREFIX` into the corresponding field:

[![Set prefix](images/image-42-33_MESHPREFIX.jpg?classes=img-maxsize)](images/image-42-33_MESHPREFIX.jpg)
