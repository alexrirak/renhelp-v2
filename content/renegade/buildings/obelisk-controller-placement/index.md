...
summary: Explains how to correctly position the Obelisk controller so that it fires
  from the proper location during gameplay.
tools:
- LevelEdit
author: zunnie
skill: 1
...
[![obelisk-placement](images/Image1.jpg)](images/Image1.jpg)
...
[![controller-properties](images/Image2.jpg)](images/Image2.jpg)

After adjusting the Z value, the controller will appear **underneath the map**.  
This is **normal** and expected.

[![controller-under-map](images/Image3.jpg)](images/Image3.jpg)
